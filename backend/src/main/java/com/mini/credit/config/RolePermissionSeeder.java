 ...
 *
 * Crée :
 * - Tous les rôles actifs (ADMIN, CHEF_BUREAU, GESTIONNAIRE, AGENT_TERRAIN,
 *   CONTROLEUR, CAISSIER, COO, RCI, GERANT_GENERAL, MEMBER)
...
public class RolePermissionSeeder {
    ...
    private Map<RoleCode, Role> createRoles(RoleRepository roleRepository) {
        ...
        Role[] roleArray = {
            ...
            Role.builder()
                    ...
                    .build(),
                Role.builder()
                    .code(RoleCode.GESTIONNAIRE)
                    .libelle("Gestionnaire")
                    .description("Pré-analyse crédit, suivi administratif et supervision terrain")
                    .isActive(true)
                    .build(),
            Role.builder()
    ...
    private Map<PermissionCode, Permission> createPermissions(PermissionRepository permissionRepository) {
        ...
        Permission[] permissionArray = {
            ...
            Permission.builder().code(PermissionCode.AGENT_TERRAIN_READ).description("Voir les agents terrain").isActive(true).build(),
            Permission.builder().code(PermissionCode.SITE_READ).description("Voir les sites").isActive(true).build(),
            Permission.builder().code(PermissionCode.TERRAIN_ACTIVITY_READ).description("Voir les activités terrain").isActive(true).build(),
            Permission.builder().code(PermissionCode.PERFORMANCE_TERRAIN_READ).description("Voir les performances terrain").isActive(true).build(),
            Permission.builder().code(PermissionCode.CREDIT_PRE_ANALYSE).description("Effectuer la pré-analyse crédit").isActive(true).build(),
            Permission.builder().code(PermissionCode.RECLAMATION_READ).description("Voir les réclamations").isActive(true).build(),
            Permission.builder().code(PermissionCode.RECLAMATION_COMMENT).description("Commenter les réclamations").isActive(true).build(),
            ...
            Permission.builder().code(PermissionCode.TICKET_RECU_READ).description("Consulter les tickets reçus").isActive(true).build(),
            Permission.builder().code(PermissionCode.TICKET_RECU_PRINT).description("Imprimer les tickets reçus").isActive(true).build(),
            Permission.builder().code(PermissionCode.TICKET_RECU_DUPLICATA).description("Générer un duplicata de ticket reçu").isActive(true).build(),
            Permission.builder().code(PermissionCode.TICKET_RECU_VERIFY).description("Vérifier authenticité ticket reçu").isActive(true).build(),
            Permission.builder().code(PermissionCode.TICKET_RECU_ADMIN).description("Administrer les tickets reçus").isActive(true).build(),
            ...
            // ============ WorkflowTask ============
            Permission.builder().code(PermissionCode.TASK_READ_OWN).description("Lire ses tâches utilisateur").isActive(true).build(),
            Permission.builder().code(PermissionCode.TASK_READ_ANTENNE).description("Lire les tâches de son antenne").isActive(true).build(),
            Permission.builder().code(PermissionCode.TASK_COMPLETE).description("Terminer une tâche utilisateur").isActive(true).build(),
            Permission.builder().code(PermissionCode.TASK_SUPERVISE).description("Superviser les tâches d'une antenne").isActive(true).build(),
            Permission.builder().code(PermissionCode.TASK_AUDIT).description("Auditer les tâches workflow").isActive(true).build(),
    ...
    private Map<RoleCode, Set<PermissionCode>> buildPermissionMatrix() {
        ...
        matrix.put(RoleCode.ADMIN, Set.of(
                ...
                PermissionCode.TICKET_RECU_READ, PermissionCode.TICKET_RECU_PRINT,
                PermissionCode.TICKET_RECU_DUPLICATA, PermissionCode.TICKET_RECU_VERIFY,
                PermissionCode.TICKET_RECU_ADMIN,
                // Caisse
                ...
                PermissionCode.TASK_READ_OWN, PermissionCode.TASK_READ_ANTENNE,
                PermissionCode.TASK_COMPLETE, PermissionCode.TASK_SUPERVISE, PermissionCode.TASK_AUDIT,
            ...
            // CHEF_BUREAU : supervision et décision hiérarchique (hors opérations caisse quotidiennes)
            matrix.put(RoleCode.CHEF_BUREAU, Set.of(
                ...
                PermissionCode.SESSION_CAISSE_ANOMALIE_REQUEST,
                ...
                PermissionCode.DEPENSE_CAISSE_CREATE, PermissionCode.DEPENSE_CAISSE_SUBMIT,
                PermissionCode.DEPENSE_CAISSE_READ, PermissionCode.DEPENSE_CAISSE_PAY, PermissionCode.DEPENSE_CAISSE_VALIDATE, PermissionCode.DASHBOARD_CAISSE_READ,
            ...
            matrix.put(RoleCode.GESTIONNAIRE, Set.of(
                PermissionCode.MEMBRE_READ, PermissionCode.MEMBRE_CREATE, PermissionCode.MEMBRE_UPDATE, PermissionCode.MEMBRE_CLOSE,
                PermissionCode.EPARGNE_COMPTE_CREATE, PermissionCode.EPARGNE_COMPTE_READ,
                PermissionCode.EPARGNE_OPERATION_CREATE, PermissionCode.EPARGNE_OPERATION_READ,
                PermissionCode.TICKET_RECU_READ, PermissionCode.TICKET_RECU_VERIFY,
                PermissionCode.DEMANDE_CREDIT_CREATE, PermissionCode.DEMANDE_CREDIT_READ,
                PermissionCode.ANALYSE_RISQUE_CREATE, PermissionCode.ANALYSE_RISQUE_READ,
        ...
        matrix.put(RoleCode.CONTROLEUR, Set.of(
            ...
            matrix.put(RoleCode.RCI, Set.of(
                ...
                PermissionCode.RAPPORT_CAISSE_EXPORT,
                PermissionCode.RAPPORT_CAISSE_AUDIT_READ,
                PermissionCode.TICKET_RECU_READ,
                PermissionCode.TICKET_RECU_VERIFY,
            ...
            // GERANT_GENERAL : supervision de haut niveau (lecture et audit)

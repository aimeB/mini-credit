...
@Table(name = "commission", indexes = {
        @Index(name = "idx_commission_agent_id", columnList = "agent_id"),
        @Index(name = "idx_commission_periode", columnList = "datePeriodeDebut, datePeriodeFin"),
        @Index(name = "idx_commission_statut", columnList = "statut"),
        @Index(name = "idx_commission_date_creation", columnList = "dateCreation")
})
@Data
@NoArgsConstructor
@AllArgsConstructor

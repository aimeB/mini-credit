...
public class CreditMapper {
    ...
    public DemandeCreditResponse toResponse(DemandeCredit demande) {
        return DemandeCreditResponse.builder()
                ...
                .gagePropose(demande.getGagePropose())
    ...
    AgentTerrain agent = credit.getDemandeCredit() != null ? credit.getDemandeCredit().getAgent() : null;
        ...
        .agentTerrainId(agent != null ? agent.getId() : null)
        .agentTerrainNom(resolveAgentTerrainNom(agent))
    ...
    private String resolveAgentTerrainNom(AgentTerrain agent) {
        if (agent == null) {
            return null;
        }
        if (agent.getUtilisateur() != null && agent.getUtilisateur().getNomComplet() != null) {
            return agent.getUtilisateur().getNomComplet();
        }

...
class DemandeCreditControllerTest {
    ...
    @Test
    void preAnalyse_shouldBeLimitedToAdminAndGestionnaire() throws Exception {
        String expr = preAuthorizeValue("preAnalyser", Long.class, String.class);
        assertThat(expr).contains("ADMIN");
        assertThat(expr).contains("GESTIONNAIRE");
    ...
    @Test
    void analyse_shouldAllowControleurOnlyForRiskAnalysis() throws Exception {
